...
kp_val = lam * lam
kd_val = -(lam + lam)
o_g = 10 # desired orientation gain
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        if np.linalg.norm(y) < 0.1 and t_imp>5.0:
            ...
            impulse_magnitude = 2.0  # Adjust magnitude as needed
