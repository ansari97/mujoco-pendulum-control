...
XML_PATH = file_path + "/assets/kuka_iiwa_14/iiwa14.xml"
...
def main():
    ...
    # --- INITIALIZATION ---
    q_init = np.array([0, -1.5708, 1.5708, -1.5708, 1.5708, -1.0, -1.5708, 0])
    ...
    model.dof_damping[:] = 0.05  # disable damping
    ...
    lam = -1.0  # eigenvalues for Kp and Kd calculations; no imaginary part
    kp_val = lam * lam
    kd_val = -(lam + lam)
